...
export default function HomePage() {
  const tealColor = '#18A5A7';  // Define the teal color
            ...
            <div className="flex items-center">
              <Link href="/" className="flex items-center">
                <Image
                  ...
                  className="mr-2"
                />
                <span className="font-bold text-xl text-gray-800">ClassTeamUp</span> {/* Lighter */}
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-16 md:py-24 lg:py-32">
            <div className="max-w-3xl">
              <h1 className="text-4xl font-extrabold tracking-tight text-gray-800 sm:text-5xl md:text-6xl"> {/* Lighter */}
      ...
      <section id="features" className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-extrabold text-gray-800 sm:text-4xl"> {/* Lighter */}
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">Skill-Based Matching</h3> {/* Lighter */}
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">Automated Team Formation</h3> {/* Lighter */}
              <p className="text-gray-600">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">Student Profiles</h3> {/* Lighter */}
              <p className="text-gray-600">
          ...
          <div className="mt-8 flex lg:mt-0 lg:flex-shrink-0">
            <div className="inline-flex rounded-md shadow">
              <Link
                ...
                style={{ backgroundColor: tealColor, color: 'white' }}
              >
                Get started
          ...
          <div className="flex justify-center md:justify-start">
            <Link href="/" className="flex items-center">
              <Image
                ...
                className="mr-2"
              />
              <span className="font-bold text-gray-800">ClassTeamUp</span> {/* Lighter */}
            </Link>
          </div>
